...
cada tela recebe*/
type screenNavigationType = StackNavigationProp<StackParamList, 'Maternity'>
type MaternityScreenRouteType = RouteProp<StackParamList, 'Maternity'>

export default function Maternity() {
    const navigation = useNavigation<screenNavigationType>();
    const route = useRoute<MaternityScreenRouteType>();
    ...
    async function handleRegister() {
        try {
            await api.post('/hospital/validate', {
                name: name,
                cnpj: cnpj,
                street: street,
                number: number,
