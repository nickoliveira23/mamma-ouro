...
cada tela recebe*/
type screenNavigationType = StackNavigationProp<TabParamList, 'Pendente'>
type PendingScreenRouteType = RouteProp<TabParamList, 'Pendente'>

export default function Pending() {
    const navigation = useNavigation<screenNavigationType>();
    const route = useRoute<PendingScreenRouteType>();
